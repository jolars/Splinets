...
#' 
#' @description This auxiliary function generates the map between the sequential order and dyadic net structure
#' of a spline basis. It works only with indices so it can be utilize to any complete basis in the space of 
#' splines with the zero-boundary conditions. The function is useful for creating dyadic structure of the graphs
#' and whenever reference to the \code{k}-tuples and the levels of support is needed. 
#' @param n_sp positive integer, the number of splines to be organized in the dyadic net;
