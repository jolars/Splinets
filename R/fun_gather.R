...
#' @description The function returns the \code{Splinets} that groups in two \code{Splinets} objects together.
...
#' \code{\link{subsample}}  for subsampling \code{Splinets}-objects, respectively,
