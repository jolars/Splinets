...
#' @param smorder integer,  the order of the splines, default is \code{smorder=3}; Again it is inherited from the
...
#'  } 
#' @param Bsplines \code{Splinet}-object, the basis of B-splines (if not \code{NULL}); The B-splines in the \code{Splinet}-object. 
#' When this argument isnot \code{NULL} the first two arguments  
#' are not needed as they will be inherited from  \code{Bsplines}.
#' @param norm logical, a flag to indicate if the output B-splines will be normalized;
...
splinet = function(knots=NULL, smorder = 3, type = 'spnt', Bsplines=NULL, norm=F){
